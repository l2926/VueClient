...
<!--          <a :href="market" style="color: gray">{{ row.industry_name_l3 }}</a>-->
      ...
      <el-table-column width="90">
        ...
        <template #default="{ row }">
          <a :href="market" style="color: navy">{{ row.ct }}</a>
        </template>
      </el-table-column>
      <el-table-column width="90">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: navy">{{ row.all_ct }}</a>
        </template>
      </el-table-column>
      <el-table-column width="90">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: navy">{{ row.ct_pct }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Olive">{{ row.mv }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Olive">{{ row.all_mv }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Olive">{{ row.mv_pct }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Teal">{{ row.amt }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Teal">{{ row.all_amt }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
        ...
        <template #default="{ row }">
          <a :href="market" style="color: Teal">{{ row.amt_pct }}</a>
        </template>
      </el-table-column>
      <el-table-column width="120">
        <template #header>
...
const axiosTable = ()=>{
  ...
  axios.post("http://127.0.0.1:8081/index/statistics_level_excel",para_dic).then(
      (response) => {
